          ...
          <ul className="flex flex-wrap justify-center gap-12 font-medium text-base text-center">
            <li>
              <Link to={"/createpost/post"} className="flex flex-col gap-2 items-center">
                <div className="rounded-lg overflow-hidden drop-shadow-md border border-slate-400 dark:border-white cursor-pointer hover:rotate-3 transition-all duration-500">
                  <img
